...
import { Calculator, Waves, Bike, Activity, Clock, Gauge } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6 pt-4">
          <div className="flex justify-center items-center gap-2 mb-2">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Ian's 철인계산기</h1>
          </div>
        </div>
        ...
        {activeTab === 'calculator' && (
          <div className="bg-white rounded-xl shadow-lg p-4">
            ...
            <p className="text-xs text-gray-600 mt-4">거리, 시간, 속도(페이스) 중 2개 값을 입력하면 나머지는 자동계산 됩니다.</p>
          </div>
        )}
